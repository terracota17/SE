/*****************************************************************************
* Filename:          C:\Users\CJRipa\Pictures\Proyecto\PracticasSE/drivers/keypad_v1_00_a/src/keypad_selftest.c
* Version:           1.00.a
...
XStatus KEYPAD_SelfTest(void * baseaddr_p)
{
  ...
  KEYPAD_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = KEYPAD_mReadSlaveReg0(baseaddr, 0);
