/*****************************************************************************
* Filename:          C:\Users\CJRipa\Pictures\Proyecto\PracticasSE/drivers/leds_rgb_v1_00_a/src/leds_rgb_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the leds_rgb driver
...
XStatus LEDS_RGB_SelfTest(void * baseaddr_p)
{
  ...
  LEDS_RGB_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = LEDS_RGB_mReadSlaveReg0(baseaddr, 0);
  ...
  LEDS_RGB_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = LEDS_RGB_mReadSlaveReg1(baseaddr, 0);
  ...
  LEDS_RGB_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = LEDS_RGB_mReadSlaveReg2(baseaddr, 0);
