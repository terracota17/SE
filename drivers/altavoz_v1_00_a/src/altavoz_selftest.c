/*****************************************************************************
* Filename:          C:\Users\CJRipa\Videos\Proyecto\PracticasSE/drivers/altavoz_v1_00_a/src/altavoz_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the altavoz driver
...
XStatus ALTAVOZ_SelfTest(void * baseaddr_p)
{
  ...
  ALTAVOZ_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = ALTAVOZ_mReadSlaveReg0(baseaddr, 0);
